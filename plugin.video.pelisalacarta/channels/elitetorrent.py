...
BASE_URL = 'https://elitetorrent.website'
...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append( Item(channel=item.channel, title="Docus y TV"     , action="peliculas", url="https://elitetorrent.website/categoria/6/docus-y-tv/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Estrenos"       , action="peliculas", url="https://elitetorrent.website/categoria/1/estrenos/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Películas"      , action="peliculas", url="https://elitetorrent.website/categoria/2/peliculas/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Peliculas HDRip", action="peliculas", url="https://elitetorrent.website/categoria/13/peliculas-hdrip/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Peliculas MicroHD", action="peliculas", url="https://elitetorrent.website/categoria/17/peliculas-microhd/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Peliculas VOSE" , action="peliculas", url="https://elitetorrent.website/categoria/14/peliculas-vose/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Series"         , action="peliculas", url="https://elitetorrent.website/categoria/4/series/modo:mini", viewmode="movie_with_plot"))
    itemlist.append( Item(channel=item.channel, title="Series VOSE"    , action="peliculas", url="https://elitetorrent.website/categoria/16/series-vose/modo:mini", viewmode="movie_with_plot"))
